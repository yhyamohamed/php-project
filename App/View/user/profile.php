    ...
    <nav>
      <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <button class="nav-link active" id="nav-orders-tab" data-bs-toggle="tab" data-bs-target="#nav-orders"
                type="button" role="tab" aria-controls="nav-orders" aria-selected="true">Orders
        </button>
        ...
        <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
          <div class="border border-1 border-secondary p-3 pb-3 pt-3 mb-2">
            ...
            <div class="mb-3 form-floating">
              <input placeholder="example@domain.com" type="email" class="form-control" id="email" value="<?= $userData->Email ?>"
...
<!--              </div>-->
          ...
          <div class="btn-group d-flex align-items-center justify-content-center mt-3">
            <button type="submit" class="btn btn-primary flex-grow-0 me-3 border-1 border-dark" name="submit" value="submit"
                    id="submit">Update
            </button>
          </div>
        </form>
