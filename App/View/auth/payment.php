        ...
        <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
          <div class="border border-2 rounded mb-5 p-4">
            ...
            <div class="mb-3 form-floating">
              <input placeholder="example@domain.com" required type="email" class="form-control" id="email"
            ...
            <div class="mb-3 form-floating">
              <input placeholder="***" required type="password" class="form-control" id="passwordconf"
                     name="passwordconf">
